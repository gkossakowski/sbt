...
object AnalysisFormats
{
	...
	implicit def relationsFormat(implicit prodF: Format[RFF], binF: Format[RFF], intF: Format[RFF], extF: Format[RFS], csF: Format[RFS], nmsF: Format[RFS]): Format[Relations] =
		asProduct6[Relations, RFF, RFF, RFF, RFS, RFS, RFS]( (a,b,c,d,e, f) => Relations.make(a,b,c,d,e, f) )( rs => (rs.srcProd, rs.binaryDep, rs.internalSrcDep, rs.externalDep, rs.classes, rs.names) )(prodF, binF, intF, extF, csF, nmsF)
