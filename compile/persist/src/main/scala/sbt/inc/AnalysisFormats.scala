...
object AnalysisFormats
{
	...
	implicit def relationsFormat(implicit prodF: Format[RFF], binF: Format[RFF], intF: Format[RFF], intByHF: Format[RFF], extF: Format[RFS], csF: Format[RFS], nmsF: Format[RFS]): Format[Relations] =
		asProduct7[Relations, RFF, RFF, RFF, RFF, RFS, RFS, RFS]( (a,b,c,d,e,f,g) => Relations.make(a,b,c,d,e,f,g) )( rs => (rs.srcProd, rs.binaryDep, rs.internalSrcDep, rs.internalSrcDepByInheritance, rs.externalDep, rs.classes, rs.names) )(prodF, binF, intF, intByHF, extF, csF, nmsF)
