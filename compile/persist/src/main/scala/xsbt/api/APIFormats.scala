...
trait APIFormats extends FormatExtra
{
	...
	implicit def formatSource(implicit pa: Format[Array[Package]], da: Format[Array[Definition]], sa: Format[Array[String]]): Format[SourceAPI] =
		p3( (s: SourceAPI) => (s.packages, s.definitions, s.usedNames))( (p, d, n) => new SourceAPI(p, d, n) )(pa, da, sa)
